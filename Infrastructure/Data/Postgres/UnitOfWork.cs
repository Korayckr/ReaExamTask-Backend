...
public class UnitOfWork : IUnitOfWork
{
    ...
    private TweetsRepository _tweetsRepository;
    ...
    public ITweetsRepository Tweets => _tweetsRepository ??= new TweetsRepository(_postgresContext);
    public IFollowersRepository Followers => _followersRepository ??= new FollowersRepository(_postgresContext);
    public IFollowingsRepository Followings => _followingsRepository ??= new FollowingsRepository(_postgresContext);
