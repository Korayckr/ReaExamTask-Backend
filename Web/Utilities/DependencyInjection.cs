...
public static class DependencyInjection
{
    public static void AddMyScoped(this IServiceCollection serviceCollection)
    {
        ...
        serviceCollection.AddScoped<ITweetsService, TweetsService>();
        serviceCollection.AddScoped<IUserService, UserService>();
        serviceCollection.AddScoped<IFollowersService, FollowersService>();
        serviceCollection.AddScoped<IFollowingsService, FollowingsService>();
    }
